...
const classes = [
  { title: "Yoga Flow", duration: "30 min", calories: "150 kcal", image: yogaImg, tag: "Flexibilidade" },
  { title: "HIIT Explosivo", duration: "25 min", calories: "400 kcal", image: hiitImg, tag: "Cardio" },
  { title: "Força Total", duration: "45 min", calories: "350 kcal", image: strengthImg, tag: "Força" },
  { title: "Mobilidade", duration: "20 min", calories: "100 kcal", image: mobilityImg, tag: "Recuperação" },
];
